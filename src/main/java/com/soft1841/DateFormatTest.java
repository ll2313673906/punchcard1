...
public class DateFormatTest {
    public static void main(String[] args) {
        ...
        //将日期按照不同格式输出
        System.out.println("------将日期时间按照不同的格式输出------");
        System.out.println("按照java默认的日期格式：" + df1.format(date));
        System.out.println("按照java默认的日期格斯：" + df1.format(date));
        ...
        System.out.println("按照指定格式 yyyy-MM-dd hh-mm分-ss EE，区域为美国：" + df4.format(date));
